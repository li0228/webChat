...
public class ResultInfo {
	...
	public static ResultInfo errorMap(Object data) {
		return new ResultInfo(501, "error", data);
	}

	public static ResultInfo errorTokenMsg(String msg) {
		return new ResultInfo(502, msg, null);
	}

	public static ResultInfo errorException(String msg) {
		return new ResultInfo(555, msg, null);
	}
