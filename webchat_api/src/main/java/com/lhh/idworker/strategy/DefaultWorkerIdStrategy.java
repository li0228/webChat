package com.lhh.idworker.strategy;

import com.lhh.idworker.WorkerIdStrategy;
import com.lhh.idworker.utils.HttpReq;
import com.lhh.idworker.utils.Ip;
import com.lhh.idworker.utils.Props;
import com.lhh.idworker.utils.Utils;
...
public class DefaultWorkerIdStrategy implements WorkerIdStrategy {
	...
	private void syncWithWorkerIdServer() {
		String syncIds = HttpReq.get(idWorkerServerUrl).req("/sync").param("ipu", ipDotUsername).param("ids", buildWorkerIdsOfCurrentIp()).exec();
